...
var _svgInjector = _interopRequireDefault(require("@tanem/svg-injector"));
...
function (_React$Component) {
  ...
  _proto.renderSVG = function renderSVG() {
    if (this.container instanceof Node) {
      ...
      div.innerHTML = _server.default.renderToStaticMarkup(_react.default.createElement("div", null, _react.default.createElement("div", {
        className: svgClassName,
        "data-src": path,
        style: svgStyle
      })));
      var wrapper = this.container.appendChild(div.firstChild);
      (0, _svgInjector.default)(wrapper.firstChild, {
        each: each,
...
ReactSVG.propTypes = {
  ...
  onInjected: _propTypes.default.func,
