...
# 0.0.9-development (2018-06-13)
[Full Changelog](https://github.com/webpack/webpack-cli/compare/v3.0.4...v0.0.9-development)

## Chore

* badge: Add badge to display install size ([29e58ec](https://github.com/webpack/webpack-cli/commit/29e58ec))
* branding: Uncapitalize webpack name following brand guideline ([36a65d6](https://github.com/webpack/webpack-cli/commit/36a65d6))

## CLI

* prompts: Add autocomplete support for config props ([#502](https://github.com/webpack/webpack-cli/pull/502))
