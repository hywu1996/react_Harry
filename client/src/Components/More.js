  ...
  <section id="three" className="main special">
    <div className="container">
      ...
      <div className="content">
        ...
        <ul className="alt">
          <li>Volleyball and skateboarding</li>
        ...
        <ul className="alt">
          <li>
            Big fan of Jonathan Kellerman's Alex Delaware detective series
          </li>
          <li>
            Favourite animated film is <i>A Silent Voice</i>
          </li>
          <li>
            Favourite TV Series is <i>NCIS and Criminal Minds</i>
          </li>
